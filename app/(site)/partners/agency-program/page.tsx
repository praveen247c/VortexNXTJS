          ...
          <div className="container">
            ...
            <div className="grid grid-4" style={{ marginTop: "2.8rem" }}>
              ...
              <div className="card reveal">
                ...
                <h3>15% recurring revenue share</h3>
                <p className="muted">Earn 15% recurring on every client you bring onto the platform, with no cap on referrals, plus margin on paid custom agents you build and run on their behalf.</p>
