...
const STATIC_PATHS: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/nerve-centre", changeFrequency: "monthly", priority: 0.8 },
  { path: "/vortex-mind", changeFrequency: "monthly", priority: 0.8 },
  { path: "/vortex-apps", changeFrequency: "monthly", priority: 0.8 },
  { path: "/vortex-memory", changeFrequency: "monthly", priority: 0.8 },
  { path: "/ask-viq", changeFrequency: "monthly", priority: 0.8 },
  { path: "/actions", changeFrequency: "monthly", priority: 0.8 },
