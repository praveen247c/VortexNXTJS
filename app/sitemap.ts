...
const STATIC_PATHS: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/vortex-runtime", changeFrequency: "monthly", priority: 0.8 },
  ...
  // /golden-circle retired from the funnel: noindexed on the page, removed from the sitemap.
  ...
  { path: "/trust/incident-response-and-breach-notification-policy", changeFrequency: "yearly", priority: 0.3 },
  { path: "/trust/secure-sdlc-and-change-management-policy", changeFrequency: "yearly", priority: 0.3 },
  { path: "/trust/ai-model-governance-policy", changeFrequency: "yearly", priority: 0.3 },
  { path: "/trust/vendor-and-third-party-risk-policy", changeFrequency: "yearly", priority: 0.3 },
  { path: "/trust/corporate-security", changeFrequency: "yearly", priority: 0.3 },
